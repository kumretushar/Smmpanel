...
# ---------- DELETE ALL (NEW) ----------
@app.on_message(filters.text & filters.private & filters.regex("🗑️ Delete All"))
async def delete_all(client, message):
    ...
    async def confirm_handler(client, msg):
        ...
        # Delete all numbers
        num_count = db.numbers.count_documents({})
        ...
        # Delete all OTP logs
        log_count = db.otp_logs.count_documents({})
        db.otp_logs.delete_many({})
        
        await msg.reply(
            f"✅ ALL DELETED\n"
            f"━━━━━━━━━━━━━━━━━━━━━━━\n"
            f"📱 Numbers Deleted: {num_count}\n"
            f"📋 Services Deleted: All\n"
            f"📊 OTP Logs Deleted: {log_count}\n"
            f"━━━━━━━━━━━━━━━━━━━━━━━"
        )
        app.remove_handler(confirm_handler)

# ---------- ADD NUMBER (FIXED — TXT + TEXT SUPPORT) ----------
add_number_step = {}
...
# Handle TXT file and text input for add number
