...
async def start(client, message):
    ...
    # ✅ Admin ko admin keyboard, user ko user keyboard
    if is_admin(user_id):
...
# ---------- BACK TO MAIN (Admin ko user keyboard dikhaye) ----------
@app.on_message(filters.text & filters.private & filters.regex("🔙 Back to Main"))
async def back_to_main(client, message):
    user_id = message.from_user.id
    
    # ✅ Admin ko bhi user keyboard dikhao
    keyboard = user_keyboard  # ← Yeh normal user keyboard hai
    text = "📌 Main Menu (User Features)"
    
    await message.reply(
        f"✅ {text}\n"
        f"✨━━━━━━━━━━━━━━━━━━━━━━━✨\n"
        f"📱 You can now use all user features.\n"
        f"✨━━━━━━━━━━━━━━━━━━━━━━━✨",
        reply_markup=keyboard
    )
...
async def admin_panel(client, message):
    ...
    await message.reply(
        ...
        f"🔑 OTPs: {total_otp}\n"
        f"✨━━━━━━━━━━━━━━━━━━━━━━━✨\n"
        f"🔙 Click 'Back to Main' for user features.",
